...
using UserRegistrationAPI.API.Common.Attributes;
using UserRegistrationAPI.API.Common.Settings;
using UserRegistrationAPI.API.Swagger;
using UserRegistrationAPI.IoC.Configuration.DI;
using DbTools.DataBase;
namespace UserRegistrationAPI.API
{
    public class Startup
    {
        ...
        private DbTools.DataBase.DatabaseConfiguration _dbSettings = default(DbTools.DataBase.DatabaseConfiguration);
